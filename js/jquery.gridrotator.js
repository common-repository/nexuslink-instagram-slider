...
(function ($, window, undefined) {
    ...
    $.GridRotator.prototype = {
        ...
        _config: function () {
            ...
            $imgs.each(function () {
                ...
                $('<img/>').load(function () {
                    ...
                    if (video === "yes") {                
                        $img.parent().parent().css('background-image', 'url(' + GridRotator.pluginsUrl + '/images/play_overlay.png' + ')');
        ...
        _replace: function ($out) {
            ...
            if (video === "yes") {
                $inA.parent().css('background-image', 'url(' + GridRotator.pluginsUrl + '/images/play_overlay.png' + ')');
